   ...
   f:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  38:	89 c3                	mov    %eax,%ebx
    int result = sort_syscalls(pid);
  3a:	e8 1c 03 00 00       	call   35b <sort_syscalls>
    if (result < 0) {
...
malloc(uint nbytes)
{
 ...
 6f7:	73 4f                	jae    748 <malloc+0xa8>
    ...
    if(p == freep)
 6f9:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 c4 0a 00 00       	mov    0xac4,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
