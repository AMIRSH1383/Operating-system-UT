...
_create_palindrome:     file format elf32-i386
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb 14 08 00 00       	mov    $0x814,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6f7:	73 4f                	jae    748 <malloc+0xa8>
    ...
    if(p == freep)
 6f9:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 c8 0a 00 00       	mov    0xac8,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf cc 0a 00 00       	mov    $0xacc,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 792:	00 00 00 
    if(p->s.size >= nunits){
