...
int main(int argc, char *argv[]){
  ...
  1f:	e8 fc 03 00 00       	call   420 <printf>
		exit();
  24:	e8 6a 02 00 00       	call   293 <exit>
	}
    else
    {
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb d0 07 00 00       	mov    $0x7d0,%ebx
        while(*s != 0){
 ...
 5f1:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
