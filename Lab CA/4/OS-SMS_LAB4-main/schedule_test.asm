...
_schedule_test:     file format elf32-i386
   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  18:	74 42                	je     5c <main+0x5c>
    for (int i = 0; i < NUM_OF_PROCESSES; i++) 
  1a:	83 c3 01             	add    $0x1,%ebx
  1d:	83 fb 3c             	cmp    $0x3c,%ebx
  20:	74 1e                	je     40 <main+0x40>
        pid = fork();
  22:	e8 e4 02 00 00       	call   30b <fork>
        if (pid < 0) 
  27:	85 c0                	test   %eax,%eax
  29:	79 ed                	jns    18 <main+0x18>
            printf(1, "Fork failed\n");
  2b:	52                   	push   %edx
  2c:	52                   	push   %edx
  ...
  34:	e8 77 04 00 00       	call   4b0 <printf>
            exit();
  39:	e8 d5 02 00 00       	call   313 <exit>
  3e:	66 90                	xchg   %ax,%ax
            job(i);
            exit();
        }
  ...
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
  4b:	68 e5 07 00 00       	push   $0x7e5
  50:	6a 01                	push   $0x1
  52:	e8 59 04 00 00       	call   4b0 <printf>
    exit();
  57:	e8 b7 02 00 00       	call   313 <exit>
            job(i);
  5c:	83 ec 0c             	sub    $0xc,%esp
  5f:	53                   	push   %ebx
  60:	e8 0b 00 00 00       	call   70 <job>
            exit();
  65:	e8 a9 02 00 00       	call   313 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
  ...
  73:	31 d2                	xor    %edx,%edx
{
  ...
  77:	53                   	push   %ebx
  78:	83 ec 14             	sub    $0x14,%esp
    volatile long long x = 0;
  7b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  82:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    for (long long i = 0; i < job_ITERATIONS; i++)
  89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        x += i;
  90:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  93:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  96:	01 c1                	add    %eax,%ecx
  98:	11 d3                	adc    %edx,%ebx
    for (long long i = 0; i < job_ITERATIONS; i++)
  9a:	83 c0 01             	add    $0x1,%eax
        x += i;
  9d:	89 4d f0             	mov    %ecx,-0x10(%ebp)
    for (long long i = 0; i < job_ITERATIONS; i++)
  a0:	83 d2 00             	adc    $0x0,%edx
        x += i;
  a3:	89 5d f4             	mov    %ebx,-0xc(%ebp)
    for (long long i = 0; i < job_ITERATIONS; i++)
  a6:	89 c3                	mov    %eax,%ebx
  a8:	81 f3 80 96 98 00    	xor    $0x989680,%ebx
  ae:	89 d1                	mov    %edx,%ecx
  b0:	09 d9                	or     %ebx,%ecx
  b2:	75 dc                	jne    90 <job+0x20>
}
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 04 08 00 00 	jmp    *0x804(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba fa 07 00 00       	mov    $0x7fa,%edx
        while(*s != 0){
 ...
 651:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 30 0b 00 00       	mov    $0xb30,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 7c2:	00 00 00 
    if(p->s.size >= nunits){
