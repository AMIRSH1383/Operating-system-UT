...
int main(int argc, char** argv)
{
  ...
  3c:	83 c3 01             	add    $0x1,%ebx
        printf(1, "%d.%s \n" , i,argv[i]);
  3f:	68 8e 07 00 00       	push   $0x78e
  44:	6a 01                	push   $0x1
  46:	e8 05 04 00 00       	call   450 <printf>
    for(int i = 1; i < argc ; i++)
  4b:	83 c4 10             	add    $0x10,%esp
  4e:	39 de                	cmp    %ebx,%esi
  50:	75 e6                	jne    38 <main+0x38>
    exit();
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 96 07 00 00       	mov    $0x796,%edx
        while(*s != 0){
