...
int main(int argc, char *argv[]){
  ...
  29:	50                   	push   %eax
  2a:	50                   	push   %eax
  2b:	68 8c 07 00 00       	push   $0x78c
  30:	6a 01                	push   $0x1
  32:	e8 09 04 00 00       	call   440 <printf>
		list_all_processes();
  37:	e8 0f 03 00 00       	call   34b <list_all_processes>
		exit();  	
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba b0 07 00 00       	mov    $0x7b0,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 b8 0a 00 00    	mov    %edx,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 752:	00 00 00 
    if(p->s.size >= nunits){
